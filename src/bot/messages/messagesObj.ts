    ...
    admin: {
      ...
      alterarexp: {
        ...
        msgs: {
          ...
          link_erro: `[❗] Link inválido, verifique se seu link não tem espaços ou caracteres especiais.`,
          link_invalido: `[❗] Link inválido, Você não enviou um link de whatsapp. `,
          info_Grupo: `[❗] Não foi possível obter as informações do grupo, verifique se o bot é admin.`,
        },
      },
      limparcomandos: {
        descricao: '',
