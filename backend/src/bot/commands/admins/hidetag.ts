import { downloadMediaMessage, extractMessageContent } from '@innovatorssoft/baileys';
...
const command: Command = {
  ...
  category: 'admins',
  aliases: ['hidetag', 'ht', 'all'], // não mude o index 0 do array pode dar erro no guia dos comandos.
  group: true,
  admin: true,
  owner: false,
  isBotAdmin: false,
